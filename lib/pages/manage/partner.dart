...
import 'package:responsive_admin_dashboard/pages/manage/data/partner_data.dart';
...
DataRow recentUserDataRow(RecentUser userInfo, BuildContext context) {
  if (userInfo.status == "Not-Available") {
    color = Colors.red[400];
  } else if (userInfo.status == 'Available') {
    color = Colors.green;
  } else {
    color = Colors.red[400];
  }
